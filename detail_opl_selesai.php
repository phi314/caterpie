...
echo"
<a href='daftar_opl_selesai.php'><input type='submit' class='btn btn-info btn-small' value='Kembali'></a>
<a href='lihat_nilai.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-primary btn-small' value='Penilaian'></a>
