...
echo"<a href='detail_opl_selesai.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-info btn-small' value='Kembali'></a>";
?><br/><br/>
<table class="table table-hover table-condensed table-bordered">
	...
	if ($nilai == 1){
		...
		$detail='Mengerti tapi belum dapat melakukannya';
	} else if ($nilai == 3) {
