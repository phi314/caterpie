...
<ul>
	...
	<input type="button" class='btn btn-danger' value="Periode Departmen">
</ul>

<br/><br/>
<form action='export_periode_dep.php' method='post'>
<table align='center'>
<tr>
	<td><font face='calibri'><b>Departmen</b></font>&nbsp;&nbsp;&nbsp;</td>
		<td>
			<select class="form-control" name="nama_dep" required>
			<option value=''> </option>
                <?php
                    $query2 = "SELECT id_dep,nama_dep FROM departmen";
                    $result2 = mysql_query($query2);
                    while($row2=mysql_fetch_array($result2))
                    {

                        echo"<option value='$row2[nama_dep]'>$row2[nama_dep]</option>";
                    }
                ?>
            </select></td>
</tr>
<tr>
	...
	<td><input type='date' name='a_dep' required></td>
</tr>
<tr>
	<td><font face='calibri'><b>Tanggal Akhir&nbsp;&nbsp;</b></font></td>
	<td><input type='date' name='b_dep' required></td>
</tr>
<tr>
			<td></td>
			<td><table>
