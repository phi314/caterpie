...
echo"
<form method='POST' action='action_koreksi_opl_koordinator.php'>
	<table align='center'>
		<tr>
			<td><font face='calibri'><b>Koreksi</b></font>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><textarea name='koreksi_opl_koordinator'></textarea></td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td></td>
			<td><input type='submit' class='btn btn-primary' value='Simpan Koreksi'>
