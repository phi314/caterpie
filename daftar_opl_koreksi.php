...
<ul class="nav nav-pills">
	...
	<li role="presentation" class="active" ><a><font face='calibri'><big><big><big>OPL KOREKSI <small><small><span class='badge badge-warning'><?php echo"$jmla33"; ?></span></small></small></big></big></big></font></a></li>
...
echo "
<tr class='info'>
<td><small><center><font face='calibri'><a href='detail_opl_koreksi.php?no_opl_temp=$row[no_opl_temp]'>$row[no_opl_temp]</a></font></center></small></td>
...
<td ><small><font face='calibri'><center>$status<br/>($tgl_koreksi)</center></font></td></small></tr>";
$no++;
} 
	if ($no_opl_temp == NULL) {
	echo"<tr class='info'><td colspan='6'><center><font face='calibri'>Tidak ada data OPL yang mempunyai status koreksi</font></center></td></tr>";
} else {echo"";}
?></tbody> 
			</table>
