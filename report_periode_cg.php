...
<ul>
	...
	<input type="button" class='btn btn-danger' value="Periode CG"></a>
...
<br/><br/>
<form action='export_periode_cg.php' method='post'>
<table align='center'>
<tr>
	<td><font face='calibri'><b>Tanggal Awal&nbsp;&nbsp;</b></font></td>
	<td><input type='date' name='a_cg' required></td>
</tr>
<tr><td><font face='calibri'><b>Tanggal Akhir&nbsp;&nbsp;</b></font></td>
	<td><input type='date' name='b_cg' required></td>
</tr>
<tr>
