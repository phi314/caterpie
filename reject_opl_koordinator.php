...
echo"
<a href='detail_opl_koordinator.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-info btn-small' value='Kembali'></a>
<form method='POST' action='action_reject_opl_koordinator.php'>
	<table align='center'>
		<tr>
			<td><font face='calibri'><b>Alasan Reject</b></font>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			<td><textarea name='reject_opl_koordinator'></textarea></td>
		</tr>
		<tr>
			<td></td>
