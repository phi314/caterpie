...
$alasan=$rowalasan['alasan_koreksi_pemeriksa'];
}

echo"
<a href='index.php'><input type='submit' class='btn btn-info btn-small' value='Kembali'></a>
<a href='approve_opl_pemeriksa.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-primary btn-small' value='Approve'></a>
<a href='koreksi_opl_pemeriksa.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-primary btn-small' value='Koreksi'></a>
<a href='reject_opl_pemeriksa.php?no_opl_temp=$no_opl_temp'><input type='submit' class='btn btn-danger btn-small' value='Reject'></a>
";
if ($alasan != NULL)
{
