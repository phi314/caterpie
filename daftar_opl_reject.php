...
<ul class="nav nav-pills">
    ...
    <li role="presentation" class="active" ><a><font face='calibri'><big><big><big>OPL REJECT <small><small><span class='badge badge-warning'><?php echo"$jmla22"; ?></span></small></small></big></big></big></font></a></li>
...
echo "
<tr class='info'>
<td><small><center><font face='calibri'><a href='detail_opl_reject.php?no_opl_temp=$row[no_opl_temp]'>$row[no_opl_temp]</a></font></center></small></td>
...
<td ><small><font face='calibri'><center>$status<br/>($row[tgl_reject])</center></font></td></small>
<td><center><small><font face='calibri'>
<a href='hapus_opl_reject.php?no_opl_temp=$no_opl_temp'><span class='badge badge-important'><b>Hapus Data</b></span></a></font></small></center></td>
</tr>";
$no++;
} 
	if ($no_opl_temp == NULL) {
	echo"<tr class='info'><td colspan='6'><center><font face='calibri'>Tidak ada data OPL yang mempunyai status reject</font></center></td></tr>";
} else {echo"";}
?></tbody> 
			</table>
