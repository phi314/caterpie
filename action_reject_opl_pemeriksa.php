<?php
require("koneksi.php");	
$reject_opl_pemeriksa=mysql_escape_string($_POST['reject_opl_pemeriksa']);
$no_opl_temp=$_POST['no_opl_temp'];
date_default_timezone_set('Asia/Jakarta');
	$tgl_reject_pemeriksa = date('Y-m-d H:i:s');
mysql_query("update opl set status=8, tgl_reject='$tgl_reject_pemeriksa', alasan_reject_pemeriksa='$reject_opl_pemeriksa'
