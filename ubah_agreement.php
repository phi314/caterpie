...
<center><font face='calibri'><b>Ubah Konfigurasi Agreement User</b></font></center><br/>
<form action='ubah_setting_agreement.php' method='POST' enctype='multipart/form-data'>
<table align='center'> 
	<tr>
	...
	<tr><td></td><td><input type='hidden' name='id' value='<?php echo"$id_ao"; ?>'><br/></td></tr>
	<tr>
		<td></td>
